...
$stmt = $conn->prepare("INSERT INTO Apex (Username, Level, Kills, KillsPerMatch, KillsAsLeader, Damage, Revives, MatchesPlayed)  
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("siiiiiii", $username, $level, $kills, $killspm, $killsaslead, $damage, $revives, $matchesplayed);
